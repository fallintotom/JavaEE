...
<br><br><br>
<div align="center">
<form method="post" action="insertanswer.do" enctype="multipart/form-data">
<div id="div1">
答案编号：<input type="text" name="a_id" value="${a_id}"><br>  
问题编号：<input type="text" name="q_id" value="${q_id}"><br>
学生编号：<input type="text" name="user_id"><br>
问题题目：${title}<br>
答案内容：<input type="checkbox" name="content" value="A">A
<input type="checkbox" name="content" value="B">B
<input type="checkbox" name="content" value="C">C
<input type="checkbox" name="content" value="D">D<br>
解答时间：<input id="date" name="a_time" type="date" style="width:145px"><br>
题目类型：<select name="type" size="${type}" id="type" style="width:150px">
