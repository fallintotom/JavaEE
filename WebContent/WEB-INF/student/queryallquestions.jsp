...
<br><br>
<div align="center">
<form method="post" action="searchquestion.do">
...
<table border="1" id="问题表">
	<tr>
		...
		<td><div class="div1" align="center">章节主题</div></td>
	...
	<c:forEach items="${list}" var="t_question">
		<tr>
			...
			<td><div class="div1" align="center"><a href="searchanswer.do?type=${t_question.getType()}&&title=${t_question.title}">查找答案</a></div></td>
			<td><div class="div1" align="center"><a href="toinsertanswer.do?type=${t_question.type}&&title=${t_question.title}&&q_id=${t_question.q_id}&&c_id=${t_question.c_id}">答疑解惑</a></div></td>
			<td><div class="div1" align="center"><a href="tostudentupdatequestion.do?type=${t_question.getType()}&&title=${t_question.title}&&q_id=${t_question.q_id}&&c_id=${t_question.c_id}&&username=${username}&&q_username=${t_question.q_username}">编辑问题</a></div></td>
		</tr>
	</c:forEach>
</table>
</div>
