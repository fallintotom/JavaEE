...
<div align="center" id="title"><h1>欢迎使用课堂交流系统！</h1></div>
<body>
...
学生编号：<input type="text" name="user_id" value="${user_id}"><br>
问题题目：${title}<br>
答案内容：<input type="radio" name="content" value="True">True
<input type="radio" name="content" value="False">False<br>
