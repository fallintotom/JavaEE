...
<body>
<br><br><br><br><br>
<div class="div1" style="margin-left:35px;">您好,<a href="querystudentmessage.do?username=${username}">${username}</a>同学!
...
<table border="1" id="答案表">
	...
	<c:forEach items="${listpt}" var="t_answer">
		<tr>
			...
			<td><div align="center" class="div3">${t_answer.type}</div></td>
			<td><img src="<%=request.getContextPath()%>${t_answer.picturepath}"  alt="" width="100" height="100"/></td>
			<td><div align="center" class="div1"><a href="toupdateanswer.do?a_id=${t_answer.a_id}&&q_id=${t_answer.q_id}&&user_id=${t_answer.user_id}&&type=${t_answer.type}&&title=${title}&&username=${username}">重新编辑</a></div></td>
		</tr>
	</c:forEach>
</table>
</div>
