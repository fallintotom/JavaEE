...
问题题目：${title}<br>
答案内容：<input type="text" name="content"><br>
解答时间：<input id="date" name="a_time" type="date" style="width:148px"><br>
题目类型：<select name="type" size="${type}" id="type" style="width:153px">
