...
<br><br><br>
<div align="center">
<form method="post" action="teacherupdatequestion.do">
<div id="div1">
问题编号：<input type="text" name="q_id" value="${q_id}" readonly><br>  
标题：<input type="text" name="title"  placeholder="问题中不能包含中文字符" value="${title}" style="margin-left:31px;"><br>
...
提问账户名：<input type="text" name="q_username" value="${q_username}" style="margin-right:16px;"><br>
