...
<br><br><br>
<div align="center">
<form method="post" action="teacherinsertchapter.do">
<div id="div1">
章节编号：<input type="text" name="c_id" value="${c_id}"><br>  
章节主题：<input type="text" name="c_name"><br><br>
<input type="submit" value="新增章节" style="margin-right:40px;"><input type="button" value="返回"  onclick="history.back()"/><br><br>
</div>
</form>
<br>
</div>
